#!/bin/bash
#
# File: run_dds_sin_rom_tb.sh
# Date: 2016-03-25
# Author: Andreas Mueller
#
# Description: Run simulation of the dds_sin_rom module testbench using iverilog.
#
...
TOP_MODULE_NAME="dds_sin_rom"
TOP_MODULE_FILE="${RTL_DIR}/${TOP_MODULE_NAME}.v"
TEST_BENCH_NAME="dds_sin_rom_tb"
